...
@section('keyTitle', $categoryName ?? 'Category')
...
<section class="category-header d-none d-sm-block">
    ...
    <ol class="breadcrumb bg-white p-2 rounded">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('category.products', $mainCategoryId?? 'null') }}">{{ $mainCategory ?? '' }}</a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{ route('subcategory.products', $id) }}">{{ $categoryName ?? 'Category' }}</a>
        </li>
            ...
            {{-- <div class="col-md-6 col-12">
                <div class="sort-section justify-content-end">
...
<section class="category-header d-block d-sm-none">
    ...
    <ol class="breadcrumb bg-white p-2 rounded">
        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
        <li class="breadcrumb-item">
            <a href="{{ route('category.products', $mainCategoryId?? '') }}">{{ $mainCategory ?? 'Category' }}</a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{ route('subcategory.products', $id) }}">{{ $categoryName ?? 'Category' }}</a>
        </li>
